...
const ChatSidebar = () => {
    ...
    const [role, setRole] = useState(sessionStorage.getItem("userRole") || localStorage.getItem("userRole") || "student");
    const name = sessionStorage.getItem("studentName") || localStorage.getItem("studentName") || "Anonymous";
